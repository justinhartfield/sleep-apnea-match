...
const CLINIC_DATABASE = {
    ...
    states: {
        'Alaska': {
            cities: [
                { name: 'Anchorage', clinics: 7, avgPrice: 5500, description: 'sleep surgery clinics in Anchorage' },
            ]
        },
        'Arizona': {
            cities: [
                { name: 'Phoenix', clinics: 9, avgPrice: 5500, description: 'sleep surgery clinics in Phoenix' },
                { name: 'Tucson', clinics: 4, avgPrice: 5500, description: 'sleep surgery clinics in Tucson' },
                { name: 'Scottsdale', clinics: 7, avgPrice: 5500, description: 'sleep surgery clinics in Scottsdale' },
            ]
        },
        'California': {
            cities: [
                { name: 'Los Angeles', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in Los Angeles' },
                { name: 'San Diego', clinics: 3, avgPrice: 12500, description: 'sleep surgery clinics in San Diego' },
                { name: 'San Jose', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in San Jose' },
                { name: 'San Francisco', clinics: 4, avgPrice: 5500, description: 'sleep surgery clinics in San Francisco' },
                { name: 'Fresno', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in Fresno' },
                { name: 'Sacramento', clinics: 6, avgPrice: 5500, description: 'sleep surgery clinics in Sacramento' },
            ]
        },
        'Colorado': {
            cities: [
                { name: 'Denver', clinics: 4, avgPrice: 5500, description: 'sleep surgery clinics in Denver' },
            ]
        },
        'Florida': {
            cities: [
                { name: 'Jacksonville', clinics: 7, avgPrice: 5500, description: 'sleep surgery clinics in Jacksonville' },
                { name: 'Miami', clinics: 4, avgPrice: 5500, description: 'sleep surgery clinics in Miami' },
                { name: 'Tampa', clinics: 6, avgPrice: 5500, description: 'sleep surgery clinics in Tampa' },
                { name: 'Orlando', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in Orlando' },
            ]
        },
        'Georgia': {
            cities: [
                { name: 'Atlanta', clinics: 8, avgPrice: 9500, description: 'sleep surgery clinics in Atlanta' },
            ]
        },
        'Hawaii': {
            cities: [
                { name: 'Honolulu', clinics: 5, avgPrice: 10000, description: 'sleep surgery clinics in Honolulu' },
            ]
        },
        'Idaho': {
            cities: [
                { name: 'Boise', clinics: 6, avgPrice: 5500, description: 'sleep surgery clinics in Boise' },
            ]
        },
        'Illinois': {
            cities: [
                { name: 'Chicago', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in Chicago' },
            ]
        },
        'Indiana': {
            cities: [
                { name: 'Indianapolis', clinics: 5, avgPrice: 18525, description: 'sleep surgery clinics in Indianapolis' },
            ]
        },
        'Kentucky': {
            cities: [
                { name: 'Louisville', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in Louisville' },
            ]
        },
        'Maryland': {
            cities: [
                { name: 'Baltimore', clinics: 4, avgPrice: 5500, description: 'sleep surgery clinics in Baltimore' },
            ]
        },
        'Massachusetts': {
            cities: [
                { name: 'Boston', clinics: 8, avgPrice: 5500, description: 'sleep surgery clinics in Boston' },
            ]
        },
        'Michigan': {
            cities: [
                { name: 'Detroit', clinics: 6, avgPrice: 5500, description: 'sleep surgery clinics in Detroit' },
            ]
        },
        'Minnesota': {
            cities: [
                { name: 'Minneapolis', clinics: 5, avgPrice: 4750, description: 'sleep surgery clinics in Minneapolis' },
            ]
        },
        'Missouri': {
            cities: [
                { name: 'St. Louis', clinics: 4, avgPrice: 5500, description: 'sleep surgery clinics in St. Louis' },
                { name: 'Kansas City', clinics: 4, avgPrice: 5500, description: 'sleep surgery clinics in Kansas City' },
            ]
        },
        'Nevada': {
            cities: [
                { name: 'Las Vegas', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in Las Vegas' },
            ]
        },
        'New Mexico': {
            cities: [
                { name: 'Albuquerque', clinics: 11, avgPrice: 5500, description: 'sleep surgery clinics in Albuquerque' },
            ]
        },
        'New York': {
            cities: [
                { name: 'New York City', clinics: 8, avgPrice: 7750, description: 'sleep surgery clinics in New York City' },
            ]
        },
        'North Carolina': {
            cities: [
                { name: 'Charlotte', clinics: 7, avgPrice: 5500, description: 'sleep surgery clinics in Charlotte' },
                { name: 'Raleigh', clinics: 7, avgPrice: 5000, description: 'sleep surgery clinics in Raleigh' },
            ]
        },
        'Ohio': {
            cities: [
                { name: 'Columbus', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in Columbus' },
                { name: 'Cleveland', clinics: 6, avgPrice: 5500, description: 'sleep surgery clinics in Cleveland' },
                { name: 'Cincinnati', clinics: 4, avgPrice: 5500, description: 'sleep surgery clinics in Cincinnati' },
            ]
        },
        'Oklahoma': {
            cities: [
                { name: 'Oklahoma City', clinics: 8, avgPrice: 1850, description: 'sleep surgery clinics in Oklahoma City' },
            ]
        },
        'Oregon': {
            cities: [
                { name: 'Portland', clinics: 6, avgPrice: 5500, description: 'sleep surgery clinics in Portland' },
            ]
        },
        'Pennsylvania': {
            cities: [
                { name: 'Philadelphia', clinics: 4, avgPrice: 2750, description: 'sleep surgery clinics in Philadelphia' },
                { name: 'Pittsburgh', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in Pittsburgh' },
            ]
        },
        'Tennessee': {
            cities: [
                { name: 'Nashville', clinics: 8, avgPrice: 5500, description: 'sleep surgery clinics in Nashville' },
                { name: 'Memphis', clinics: 6, avgPrice: 2275, description: 'sleep surgery clinics in Memphis' },
            ]
        },
        'Texas': {
            cities: [
                { name: 'Houston', clinics: 7, avgPrice: 5500, description: 'sleep surgery clinics in Houston' },
                { name: 'San Antonio', clinics: 6, avgPrice: 5500, description: 'sleep surgery clinics in San Antonio' },
                { name: 'Dallas', clinics: 4, avgPrice: 14250, description: 'sleep surgery clinics in Dallas' },
                { name: 'Austin', clinics: 4, avgPrice: 5250, description: 'sleep surgery clinics in Austin' },
                { name: 'Fort Worth', clinics: 5, avgPrice: 875, description: 'sleep surgery clinics in Fort Worth' },
            ]
        },
        'Utah': {
            cities: [
                { name: 'Salt Lake City', clinics: 6, avgPrice: 3250, description: 'sleep surgery clinics in Salt Lake City' },
            ]
        },
        'Washington': {
            cities: [
                { name: 'Seattle', clinics: 4, avgPrice: 5500, description: 'sleep surgery clinics in Seattle' },
            ]
        },
        'Washington DC': {
            cities: [
                { name: 'Washington', clinics: 5, avgPrice: 5500, description: 'sleep surgery clinics in Washington' },
            ]
        },
        'Wisconsin': {
            cities: [
                { name: 'Milwaukee', clinics: 8, avgPrice: 344, description: 'sleep surgery clinics in Milwaukee' },
            ]
        },
    },
    ...
    cities: {
        'new_york_city': {
            ...
            clinicCount: 8,
            clinics: [
                { name: 'sleep apnea surgery NYC', address: '2279 Coney Island Ave, Brooklyn, NY 11223', phone: '(718) 488-0188', specialty: 'Orthopedic, Spine, Sports Medicine', priceRange: 'Contact for pricing', featured: true, verified: true },
                ...
                { name: 'sleep apnea Specialist NY', address: '20 East 46th Street, 9th Floor Midtown, East New York, New York, NY 10017', phone: '(646) 494-1677', specialty: 'Chronic Diseases, Chronic Fatigue, Sports Injuries', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Weill Cornell Medicine sleep surgery', address: '525 East 68th Street, 16th Floor, New York, NY 10065', phone: '212-746-1500', specialty: 'Rehabilitation Medicine, Tendinopathy, Osteoarthritis', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'ColumbiaDoctors - Rehabilitation & sleep surgery', address: '', phone: '212-305-3535', specialty: 'Rehabilitation & sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'los_angeles': {
            ...
            clinics: [
                ...
                { name: 'Dr. Steve Yoon', address: '6801 Park Terrace, Suite 125 Los Angeles, CA 90045', phone: '(310) 890-1411', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'san_diego': {
            cityName: 'San Diego',
            ...
            clinicCount: 3,
            clinics: [
                { name: 'R3 sleep apnea San Diego', address: '', phone: '(844) 438-7836', specialty: 'orthopedic, sports medicine, chronic pain', priceRange: '\$5,000 - \$20,000', featured: true, verified: true },
                { name: 'Sanford sleep surgery clinical Center CIRM Alpha Clinic', address: '9400 Campus Point Drive, La Jolla, CA 92037', phone: '(844) 317-7836', specialty: 'spinal cord injury, cancer, Crohn\'s disease', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Total sleep apnea', address: '5720 Oberlin Drive, San Diego, CA 92121', phone: '(858) 771-4100', specialty: 'joint pain, hair loss', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'san_jose': {
            cityName: 'San Jose',
        ...
        'san_francisco': {
            ...
            clinicCount: 4,
            clinics: [
                { name: 'Advanced sleep apnea Institute', address: 'Not explicitly stated on the page, but they have offices in California.', phone: '(213) 460-5099, (844) 464-5950, 760-878-7136', specialty: 'Orthopedic (knee pain, hip pain, shoulder & elbow pain, hand & wrist pain, back & neck pain), Hair Restoration, Facial Rejuvenation', priceRange: 'Contact for pricing', featured: true, verified: true },
                ...
                { name: 'Eli and Edythe Broad Center of Regeneration Medicine and sleep apnea Research at UCSF', address: 'Not explicitly stated on the homepage, but it is part of UCSF.', phone: 'Not explicitly stated on the homepage.', specialty: 'This is a research center, not a clinical practice. They focus on basic science and accelerating sleep apnea therapies.', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Golden Gate sleep apnea', address: '2100 Webster St. #309, San Francisco, CA 94115', phone: '415-923-3028', specialty: 'Orthopedic and degenerative conditions', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'fresno': {
            cityName: 'Fresno',
            ...
            clinicCount: 5,
            clinics: [
                { name: 'Optimal Medical Group', address: 'Fresno, CA', phone: 'Contact clinic directly', specialty: 'sleep surgery', priceRange: 'Avg \$5,500', featured: true, verified: true },
            ]
        },
        'sacramento': {
            cityName: 'Sacramento',
            ...
            clinicCount: 6,
            clinics: [
                { name: 'UC Davis sleep apnea Program', address: '2315 Stockton Boulevard, Sacramento, CA 95817', phone: '916-703-9300', specialty: 'Research, Crohn\'s Disease, B-Cell Non-Hodgkin\'s Lymphoma', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'R3 sleep apnea', address: '1600 Creekside Dr #3300, Folsom, CA 95630', phone: '+1 (844) 438-7836', specialty: 'Pain Management, Orthopedics, Neuropathy', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'chicago': {
            ...
            clinicCount: 5,
            clinics: [
                { name: 'Chicago sleep apnea surgery & Pain Management Institute', address: '10181 W Lincoln Hwy, Frankfort, IL 60423', phone: '(815) 464-7212', specialty: 'Pain Management, Orthopedics, Autoimmune Disorders', priceRange: 'Contact for pricing', featured: true, verified: true },
                ...
                { name: 'Chicago sleep apnea and Exosomes', address: '2138 N Damen Ave Suite 1, Chicago, IL 60647', phone: '(773) 904-9772', specialty: 'sleep apnea surgery, Exosome Therapy, PRP', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'The Prodromos sleep apnea Institute', address: '1714 Milwaukee Avenue, Glenview, IL 60025', phone: '(847) 699-6810', specialty: 'Orthopaedics, Anti-aging, Asthma/COPD', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'houston': {
            ...
            clinicCount: 7,
            clinics: [
                { name: 'sleep surgery center Houston', address: '', phone: '(832) 808-7714', specialty: 'Orthopedic', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'Cendant sleep surgery center', address: '', phone: '713-552-3142', specialty: 'Orthopedics, Neurological, Autoimmune', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Texas Pain and sleep surgery', address: '11226 SOUTHWEST FWY, Suite A, Houston, TX 77031', phone: '832-536-9891', specialty: 'Pain Management, Alternative Medicine', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'MD Anderson Cancer Center - sleep apnea Transplantation & Cellular Therapy', address: '1515 Holcombe Blvd, Houston, TX 77030', phone: '713-745-3987', specialty: 'Cancer Treatment, Hematologic Cancers, Solid Tumors', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Houston sleep surgery', address: '', phone: '(346) 581-1547', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'san_antonio': {
            ...
            clinicCount: 6,
            clinics: [
                { name: 'The sleep apnea Institute of Texas', address: '540 Oak Centre Drive, Suite 114, San Antonio, TX 78258', phone: '(210) 985-1700, (210) 941-4815', specialty: 'cosmetics, orthopaedic', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'Woywood Integrated Medicine', address: '12702 Toepperwein Rd. #142, Live Oak, TX 78233', phone: '(210) 646-9060', specialty: 'Chiropractic, Pain Relief, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Shaun Jackson, M.D.', address: '423 Treeline Park Ste 325, San Antonio, TX 78209', phone: '(210) 546-1460', specialty: 'Pain Treatment, sleep surgery, Wellness', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'dallas': {
            ...
            clinicCount: 4,
            clinics: [
                { name: 'Innovations sleep surgery center', address: '12660 Coit Rd, Suite 100, Dallas, TX 75251', phone: '(972) 893-9849', specialty: 'Musculoskeletal, Neurological Disorders, Autoimmune Diseases', priceRange: '\$12,500 - \$16,000', featured: true, verified: true },
                ...
                { name: 'The sleep apnea Institute', address: '7709 San Jacinto Place, STE 101, Plano, TX 75024', phone: '(214) 709-1904', specialty: 'Back Pain, Lower Back Pain, Leg & Arm Pain', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'austin': {
            cityName: 'Austin',
            ...
            clinicCount: 4,
            clinics: [
                { name: 'The Center For Healing & sleep surgery (CHARM)', address: '10815 Ranch Rd 2222, Building 3B, Suite 200, Austin, TX 78730', phone: '(512) 641-6230', specialty: 'Orthopedics, Sports Medicine, Spine', priceRange: 'Contact for pricing', featured: true, verified: true },
        ...
        'fort_worth': {
            ...
            clinics: [
                ...
                { name: 'Atlas Medical Center', address: '1301 N Beach St, Fort Worth, TX 76111', phone: '817.290.6988', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'phoenix': {
            ...
            clinicCount: 9,
            clinics: [
                { name: 'Innate Healthcare Institute', address: 'Phoenix, AZ', phone: 'Contact clinic directly', specialty: 'sleep surgery', priceRange: 'Avg \$5,500', featured: true, verified: true },
            ]
        },
        'tucson': {
            cityName: 'Tucson',
            ...
            clinics: [
                ...
                { name: 'R3 sleep apnea', address: '', phone: '', specialty: 'Pain Management, Joint Stress, Arthritis', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'scottsdale': {
            ...
            clinics: [
                ...
                { name: 'R3 sleep apnea', address: '10045 E Dynamite Boulevard Suite 235, Scottsdale, AZ 85262', phone: '(480) 306-6256', specialty: 'Autoimmune, Cardiovascular, Endocrine', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'sleep apnea surgery Professionals', address: '11000 N Scottsdale Rd Ste 135, Scottsdale, AZ 85254', phone: '480-267-7856', specialty: 'Joint Pain, Hair Loss, Hormone Replacement', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Scottsdale sleep surgery & Wellness', address: '8406 E. Shea Blvd. Suite 102, Scottsdale, AZ 85260', phone: '(602) 292-2978', specialty: 'Prolotherapy sleep surgery, Prolozone, Neural Therapy Injections', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'philadelphia': {
            ...
            clinicCount: 4,
            clinics: [
                { name: 'sleep apnea Philadelphia', address: '459 Sproul Road, Villanova, PA 19085', phone: '(267) 497-3848', specialty: 'sleep surgery, Aesthetics, Sexual Wellness', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'Jefferson sleep apnea & Regenerative Neuroscience Center', address: '900 Walnut Street, Room 461, Jefferson Hospital for Neuroscience, Philadelphia, PA 19107', phone: '', specialty: 'Regenerative Neuroscience Research', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'R3 sleep apnea', address: 'Philadelphia, PA', phone: '(844) 438-7836', specialty: 'Orthopedics, Neurology, Pain Management', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'pittsburgh': {
            cityName: 'Pittsburgh',
            ...
            clinics: [
                ...
                { name: 'Aspire Rejuvenation Clinic', address: '180 Swinderman Rd Suite 300, Wexford, PA 15090', phone: '(412) 615-3804', specialty: 'sleep surgery, Aesthetics', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Valerie P Donaldson, MD, sleep surgery Center', address: '17 Brilliant Avenue, Suite 202A, Aspinwall, PA 15215', phone: '412-767-9890', specialty: 'Aesthetics, Bioidentical Hormone Therapy, EMFACE', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'UPMC - The McGowan Institute for sleep surgery', address: 'Bridgeside Point II, 450 Technology Drive, Suite 300, Pittsburgh, PA 15219', phone: '412-624-5500', specialty: 'Research in tissue engineering, cellular therapies, and artificial and biohybrid organ devices.', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'jacksonville': {
            ...
            clinicCount: 7,
            clinics: [
                { name: 'North Florida sleep apnea', address: '421 Kingsley Ave #200, Orange Park, FL 32073', phone: '904-215-5800', specialty: 'sleep surgery, Autism, Neurological', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'Kevin M. Kaplan, MD, FAAOS', address: '5191 First Coast Technology Parkway, 3rd Floor, Jacksonville, FL 32224', phone: '(904) 675-4000', specialty: 'Orthopaedic Surgeon, Sports Medicine, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Max Lincoln, MD - Fleming Island Office', address: '4565 US Highway 17, Ste. 200, Fleming Island, FL 32003', phone: '(904) 634-0640', specialty: 'Orthopedic Surgeon, Total Joint Replacement, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Max Lincoln, MD - Riverside Office', address: '2627 Riverside Avenue, Ste. 300, Jacksonville, FL 32204', phone: '(904) 634-0640', specialty: 'Orthopedic Surgeon, Total Joint Replacement, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Max Lincoln, MD - Northside Clinic Office', address: '15255 Max Leggett Pkwy, Ste. 5300, Jacksonville, FL 32218', phone: '(904) 634-0640', specialty: 'Orthopedic Surgeon, Total Joint Replacement, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'miami': {
            ...
            clinicCount: 4,
            clinics: [
                { name: 'Miami sleep apnea', address: '7330 SW 62nd Place, Suite 320A, South Miami, Florida 33143', phone: '(305) 598-7777', specialty: 'Pain Management, Anti-Aging, Hair Restoration', priceRange: 'Contact for pricing', featured: true, verified: true },
                ...
                { name: 'STEMS Health sleep surgery', address: '925 West 41st Street Suite #300A, Miami Beach, Florida 33140', phone: '(305) 677-0565', specialty: 'Pain Management, Spine & Joint Health, PRP Treatments', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'tampa': {
            ...
            clinics: [
                ...
                { name: 'Axis sleep apnea Institute', address: 'Bayfront Hospital, St. Petersburg, FL 33701', phone: '206-415-2947', specialty: 'Regenerative Sports Medicine, Neurodegenerative Disorders, Autoimmune Disorders', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Heim sleep surgery Center', address: '4240 Henderson Blvd, Tampa, FL 33629', phone: '(813) 384-3107', specialty: 'Anti-Aging, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'The sleep apnea Medical Center', address: 'Antigua', phone: '1-352-320-2688', specialty: 'Anti-Aging Wellness, Facial Rejuvenation, Sports Injuries', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'orlando': {
            cityName: 'Orlando',
            ...
            clinicCount: 5,
            clinics: [
                { name: 'Orlando Center for sleep surgery', address: '801 N. Orange Ave., #600 B, Orlando, FL 32801', phone: '(407) 841-0001', specialty: 'joint pain, shoulder, elbow', priceRange: 'Contact for pricing', featured: true, verified: true },
                ...
                { name: 'AdventHealth Medical Group sleep apnea Transplant and Cellular Therapy at Orlando', address: '2415 North Orange Avenue, Suite 601, Orlando, FL 32804', phone: '407-303-2070', specialty: 'Aplastic Anemia, Blood Cancers, Cancer Care', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'sleep apnea Medical Center', address: 'N/A (Facility in Antigua)', phone: '1-352-320-2688', specialty: 'Autoimmune Disorders, Cardiovascular Conditions, Sexual Wellness', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'columbus': {
            cityName: 'Columbus',
            ...
            clinicCount: 5,
            clinics: [
                { name: 'OhioHealth McConnell Spine, Sport and Joint Center', address: 'Columbus, OH', phone: 'Contact clinic directly', specialty: 'sleep surgery', priceRange: 'Avg \$5,500', featured: true, verified: true },
            ]
        },
        'cleveland': {
            cityName: 'Cleveland',
            ...
            clinicCount: 6,
            clinics: [
                { name: 'sleep apnea Cleveland', address: '25200 Center Ridge Road, Suite 3300, Westlake, Ohio 44145', phone: '440-306-3200', specialty: 'Spine Pain, Tendon Injuries, Osteoarthritis', priceRange: 'Contact for pricing', featured: true, verified: true },
                ...
                { name: 'R3 sleep apnea', address: '25111 Country Club Blvd #235, North Olmsted, OH 44070', phone: '(844) 438-7836', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'cincinnati': {
            ...
            clinics: [
                ...
                { name: 'Renew Medical Centers', address: 'Not immediately available on the website, but they have a contact number.', phone: '(513) 561-7836', specialty: 'sleep surgery, medical weight loss, wellness treatments', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'RestoreMD', address: '15 Cincinnati Ave, Suite 5, Lebanon, OH 45036', phone: '513-880-0554', specialty: 'Integrative medicine, sleep surgery, arthritis', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'charlotte': {
            cityName: 'Charlotte',
            ...
            clinicCount: 7,
            clinics: [
                { name: 'NeoGenix sleep apnea & Regenerative Therapies', address: '16147 Lancaster Hwy #140, Charlotte, NC 28277', phone: '704-727-6551', specialty: 'Orthopedic, Joint Pain, Ligament and Tendon Injuries', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'sleep apnea Carolina', address: '8035 Providence Road Suite 340, Charlotte, NC 28277', phone: '704-542-3988', specialty: 'Non-surgical orthopedics, Interventional sports and spine medicine', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Heritage sleep surgery', address: '8058 Corporate Center, Suite 300, Charlotte, NC 28226', phone: '980-210-0079', specialty: 'sleep surgery, Functional Medicine, Anti-aging', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'sleep apnea Medical Center', address: 'Antigua (Serves Charlotte)', phone: '1-352-320-2688', specialty: 'Anti-Aging, Sports Injuries, Aesthetic Enhancement', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'raleigh': {
            cityName: 'Raleigh',
        ...
        'indianapolis': {
            ...
            clinics: [
                ...
                { name: 'Sports & sleep surgery', address: '7911 N Michigan Rd., Indianapolis IN, 46268', phone: '(317) 660-2173', specialty: 'Sports Medicine, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'RAYUS Radiology - Indianapolis, IN - East', address: '1250 N. Post Rd.,, Suite A Indianapolis, IN, 46219', phone: '317-569-5720', specialty: 'sleep surgery, Neuroradiology, Interventional OrthoBiologics', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'RAYUS Radiology - Indianapolis, IN - Northwest', address: '7151 Marsh Rd., Suite 100 Indianapolis, IN 46278', phone: '317-846-0717', specialty: 'sleep surgery, Neuroradiology, Interventional OrthoBiologics', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Indianapolis Pain and Wellness Center', address: '1305 W. 96th Street Suite C, Indianapolis, IN, 46260', phone: '(317) 580-9867', specialty: 'sleep surgery, Chiropractic, Physiotherapy', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'seattle': {
            cityName: 'Seattle',
            ...
            clinicCount: 4,
            clinics: [
                { name: 'Seattle Sports & sleep surgery', address: '1000 Dexter Ave N #320, Seattle, WA 98109', phone: '206-620-0333', specialty: 'sports medicine, family medicine', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'Seattle sleep surgery Center', address: '1220 116th Ave NE, Suite 102 Bellevue, WA 98004', phone: '425-454-0406', specialty: 'orthopedic, spine', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Axis sleep apnea Institute', address: '10517 NE 38th Pl Bldg 11, Suite B, Kirkland, Washington 98033', phone: '206-415-2947', specialty: 'musculoskeletal, neurodegenerative, autoimmune', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Daniel Nelson, MD', address: '12911 120th Ave NE, Suite H-10, Kirkland, WA 98034', phone: '425-823-4000', specialty: 'interventional pain medicine, sleep surgery, spine pain', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'denver': {
            cityName: 'Denver',
            ...
            clinicCount: 4,
            clinics: [
                { name: 'Centeno-Schultz Clinic', address: 'Denver, CO', phone: 'Contact clinic directly', specialty: 'sleep surgery', priceRange: 'Avg \$5,500', featured: true, verified: true },
            ]
        },
        'washington': {
            cityName: 'Washington',
            ...
            clinics: [
                ...
                { name: 'GW Cancer Center - sleep apnea Transplantation and Cell Therapy Laboratories', address: 'Ross Hall at the GW School of Medicine and Health Sciences', phone: 'Not specified', specialty: 'sleep apnea Transplantation, Cell Therapy', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'West End sleep surgery', address: '2440 M St. NW Suite 200 Washington, D.C. 20037', phone: '202.750.5189', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'boston': {
            cityName: 'Boston',
            ...
            clinicCount: 8,
            clinics: [
                { name: 'Mass General Brigham - sleep surgery Program', address: 'Boston, MA', phone: 'Contact clinic directly', specialty: 'sleep surgery', priceRange: 'Avg \$5,500', featured: true, verified: true },
            ]
        },
        'nashville': {
            cityName: 'Nashville',
            ...
            clinicCount: 8,
            clinics: [
                { name: 'Vanderbilt University Medical Center', address: 'Nashville, TN', phone: 'Contact clinic directly', specialty: 'sleep surgery', priceRange: 'Avg \$5,500', featured: true, verified: true },
            ]
        },
        'memphis': {
            cityName: 'Memphis',
            ...
            clinicCount: 6,
            clinics: [
                { name: 'Schrader Orthopedic and sleep apnea treatment Center', address: '927 Cordova Station Ave. Cordova, Tennessee 38018', phone: '901-465-4300', specialty: 'Sports Medicine, neck, back', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'R3 sleep apnea', address: 'Serves Memphis, TN', phone: '+1 (844) 438-7836', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Resilient Medical Services', address: '721 W Brookhaven Circle Memphis, TN 38117', phone: '(901) 821-0945', specialty: 'sleep surgery, chronic pain, acute injuries', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'detroit': {
            ...
            clinics: [
                ...
                { name: 'Dr. Beauty', address: '29110 Inkster Rd. Suite #250, Southfield, MI 48034', phone: '248-422-2784', specialty: 'Aesthetic Services, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Karmanos Cancer Institute', address: '4100 John R St, Detroit, MI 48201', phone: '(800) 527-6266', specialty: 'Hematologic Malignancies, sleep apnea Transplantation', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'oklahoma_city': {
            ...
            clinicCount: 8,
            clinics: [
                { name: 'Oklahoma Pain Center', address: '13921 N Meridian Ave, Ste 100, Oklahoma City, OK 73134', phone: '(405) 752-9600', specialty: 'Pain Management, sleep surgery', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'R3 sleep apnea', address: 'Provider Network', phone: '(844) 438-7836', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Venturis Clinic', address: '6524 N. Western Ave, Oklahoma City, OK 73116', phone: '(405) 848-7246', specialty: 'sleep surgery, Chiropractic', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'Oklahoma Hip and Knee Specialist', address: '3130 SW 89th St. Suite 200E, Oklahoma City, OK 73159', phone: '(405) 445-0155', specialty: 'Orthopedic Surgery, Hip and Knee Specialist, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Align Interventional Pain', address: '1810 E. Memorial Road, Oklahoma City, OK 73131', phone: '405-906-4020', specialty: 'Pain Management, sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'portland': {
            ...
            clinicCount: 6,
            clinics: [
                { name: 'Cascade sleep surgery', address: 'Portland, OR', phone: 'Contact clinic directly', specialty: 'sleep surgery', priceRange: 'Avg \$5,500', featured: true, verified: true },
            ]
        },
        'las_vegas': {
            cityName: 'Las Vegas',
            ...
            clinicCount: 5,
            clinics: [
                { name: 'Cellaxys', address: 'Las Vegas, NV', phone: 'Contact clinic directly', specialty: 'sleep surgery', priceRange: 'Avg \$5,500', featured: true, verified: true },
            ]
        },
        'louisville': {
            cityName: 'Louisville',
            ...
            clinics: [
                ...
                { name: 'Kentuckiana Integrative Medicine', address: '405 E. Court Avenue, Jeffersonville, IN 47130', phone: '(812) 913-4416', specialty: 'sleep surgery, Integrative Medicine', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'baltimore': {
            ...
            clinicCount: 4,
            clinics: [
                { name: 'Center for sleep apnea Biology & sleep surgery', address: 'University of Maryland School of Medicine', phone: 'Not found', specialty: 'Research', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'R3 sleep apnea', address: 'Not specified on this page, but they have a location near Baltimore.', phone: '(844) 438-7836', specialty: 'Not specified, but they mention breathing complications, mobility issues, low energy, and pain.', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'milwaukee': {
            ...
            clinicCount: 8,
            clinics: [
                { name: 'Spectrum sleep apnea and sleep surgery Center', address: '2500 N Mayfair Rd, Suite 630, Wauwatosa, WI 53226', phone: '(262) 202-8312', specialty: 'Orthopedic, Spine, Sports Medicine', priceRange: 'Contact for pricing', featured: true, verified: true },
                ...
                { name: 'Wisconsin sleep apnea Institute', address: '675 North Barker Road, Brookfield WI 53045', phone: '(262) 200-2700', specialty: 'Orthopedics, Pain Management, Family Practice', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'albuquerque': {
            ...
            clinicCount: 11,
            clinics: [
                { name: 'NM sleep apnea', address: '918 Pinehurst Rd SE #102, Rio Rancho, NM 87124', phone: '(505) 404-9555', specialty: 'Joint Pain, Knee Pain, Spinal/Back Pain', priceRange: 'Contact for pricing', featured: true, verified: true },
        ...
        'atlanta': {
            ...
            clinics: [
                ...
                { name: 'Atlanta Innovative Medicine', address: '8460 Holcomb Bridge Road Second Floor Alpharetta, GA 30022', phone: '770.416.9995', specialty: 'sleep surgery, Orthopedics, Sports Medicine', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'R3 sleep apnea', address: 'Atlanta, GA', phone: '+1 (844) GET-STEM', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'minneapolis': {
            ...
            clinics: [
                ...
                { name: 'Twin Cities Pain & sleep surgery', address: '4444 West 76th Street, Suite 500 Edina, MN 55435', phone: '952-831-7246', specialty: 'Pain Management, sleep surgery, Knee', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Chiro Minneapolis', address: '2627 East Franklin Suite 201, Minneapolis, MN 55406', phone: '(612) 315-0437', specialty: 'Chiropractic Care, sleep surgery, Pain Relief', priceRange: 'Contact for pricing', featured: false, verified: true },
                ...
                { name: 'R3 sleep apnea', address: 'Not specified, but they have a center near Minneapolis', phone: '(844) 438-7836', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'st_louis': {
            cityName: 'St. Louis',
            ...
            clinics: [
                ...
                { name: 'sleep surgery of St. Louis', address: '1034 South Brentwood Blvd - Ste 754, St. Louis, MO 63117', phone: '(314) 973-2955', specialty: 'Neurosurgery, Spine, Chronic Pain', priceRange: 'Contact for pricing', featured: false, verified: true },
        ...
        'kansas_city': {
            ...
            clinicCount: 4,
            clinics: [
                { name: 'Unknown', address: '', phone: '', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: true, verified: true },
                { name: 'Unknown', address: '', phone: '', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Unknown', address: '', phone: '', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Unknown', address: '', phone: '', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'salt_lake_city': {
            ...
            clinics: [
                ...
                { name: 'Utah sleep apnea', address: '9980 S. 300 W, Suite 150, Sandy, UT 84070', phone: '801-999-4860', specialty: 'Joint Regeneration, IV Therapy, Medical Aesthetics', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'R3 sleep apnea', address: 'Salt Lake City, UT', phone: '+1 (844) GET-STEM', specialty: 'Pain Management, Orthopedics, Sports Medicine', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Precision Pointe Regenerative Health', address: 'Salt Lake City, UT', phone: '801-613-8002', specialty: 'sleep surgery, Pain Management', priceRange: 'Contact for pricing', featured: false, verified: true },
                { name: 'Cell Therapy and sleep surgery Program', address: 'University of Utah', phone: '', specialty: 'Hematopoietic sleep apnea Transplant, Cellular Therapy', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'honolulu': {
            cityName: 'Honolulu',
            ...
            clinicCount: 5,
            clinics: [
                { name: 'sleep apnea treatment Center of Hawaii', address: '677 Ala Moana Blvd Suite 1023, Honolulu, HI 96813', phone: '808-945-5433', specialty: 'Orthopedic, Heart & Lung, Urology', priceRange: 'Contact for pricing', featured: true, verified: true },
                ...
                { name: 'sleep surgery & Rehabilitation of Hawaii', address: 'Not specified', phone: '(808) 528-5500', specialty: 'Knee arthritis and injuries, Carpal tunnel, Disc herniation in the lower back and sciatic pain', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
        'anchorage': {
            cityName: 'Anchorage',
            ...
            clinicCount: 7,
            clinics: [
                { name: 'R3 sleep apnea', address: 'Not available', phone: '844-GET-STEM', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: true, verified: true },
        ...
        'boise': {
            ...
            clinicCount: 6,
            clinics: [
                { name: 'sleep apnea of Idaho', address: '4842 N Cortona Way, STE 110 Meridian, ID 83646', phone: '(208) 579-2037', specialty: 'orthopedic, trauma, sports medicine', priceRange: 'Contact for pricing', featured: true, verified: true },
                ...
                { name: 'R3 sleep apnea', address: '888 N Cole Rd, Boise, ID 83704', phone: '(844) 438-7836', specialty: 'sleep surgery', priceRange: 'Contact for pricing', featured: false, verified: true },
            ]
        },
    }
};
                            ...
                            <div class="lg:col-span-8">
                                        ...
                                        <div class="divide-y divide-slate-100">
                                            <div class="p-6">
                                                <div class="flex items-center justify-between">
                                                    <div>
                                                        <h4 class="font-bold text-slate-900">sleep apnea treatment</h4>
                                ...
                                <div x-show="activeTab === 'credentials'">
                                    <div class="bg-white rounded-3xl border border-slate-200 p-6">
                                        ...
                                        <p class="text-slate-600">Treatments may include PRP, BMAC (bone marrow aspirate concentrate), adipose-derived sleep apnea, and other regenerative therapies.</p>
                                    </div>
                                </div>
                            </div>
            ...
            this.$el.innerHTML = `
                <section class="py-8 md:py-12">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <p class="text-lg text-slate-600 max-w-3xl mb-8">
                            Browse ${totalClinics}+ verified sleep surgery clinics across the Golden State, including major research institutions and specialized orthopedic centers.
                        </p>
            ...
            this.$el.innerHTML = `
                <section class="py-8 md:py-12">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <h1 class="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
                            sleep surgery clinics in <span class="text-brand-600">${this.cityData.cityName}</span>
                        </h1>
                        <p class="text-lg text-slate-600 max-w-3xl mb-4">
                            ${this.cityData.clinicCount} verified sleep surgery clinics in the ${this.cityData.cityName} metro area.
                        </p>
            ...
            this.$el.innerHTML = `
                <section class="py-8 md:py-12">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <h1 class="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
                            sleep surgery clinics in <span class="text-brand-600">${this.stateName}</span>
                        </h1>
                        <p class="text-lg text-slate-600 max-w-3xl mb-12">
                            Browse ${totalClinics}+ verified sleep surgery clinics across ${this.stateName}.
                        </p>
            ...
            this.$el.innerHTML = `
                <section class="py-8 md:py-12">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="mb-12">
                            <h1 class="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
                                sleep surgery clinics in <span class="text-brand-600">All 30 States</span>
                            </h1>
                            <p class="text-lg text-slate-600 max-w-3xl mb-6">
                                Browse ${totalClinics}+ verified sleep surgery clinics across ${totalCities} cities in ${this.states.length} states.
                            </p>
                        ...
                        <div class="mt-12 p-6 bg-slate-50 rounded-2xl border border-slate-200">
                            <h3 class="text-lg font-bold text-slate-900 mb-4">Popular States for sleep apnea surgery</h3>
